...
const QuestionPanel = ({
  ...
  if (!question) {
    return (
      <div className="w-full h-full bg-white shadow-lg p-6 overflow-y-auto flex flex-col">
        ...
        <p className="text-gray-500">
          No questions assigned for this interview.
        </p>
      </div>
    );
  }
          ...
          {question.examples && question.examples.length > 0 && (
            <div>
              ...
              {question.examples.map((example, idx) => (
                <div
                  key={idx}
                  className="bg-gray-50 p-4 rounded mb-2 border-l-4 border-cyan-500"
                >
                  <p className="mb-1">
                    <strong>Input:</strong>{' '}
          ...
          {question.hints && question.hints.length > 0 && (
            <div>
              ...
              {question.hints.map((hint, idx) => (
                <details
                  key={idx}
                  className="bg-yellow-50 p-3 rounded mb-2 cursor-pointer"
                >
