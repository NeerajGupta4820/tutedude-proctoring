...
import { FaCode, FaQuestionCircle, FaComments, FaPaintBrush } from 'react-icons/fa';
      ...
      {tools.map(tool => {
        ...
        return (
          ...
          >
            ...
            {/* Tooltip */}
            <span className={`absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 ${isActive ? 'hidden' : ''}`}>
              {tool.label}
