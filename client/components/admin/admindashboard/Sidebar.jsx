...
const Sidebar = ({ 
  ...
  const [expandedItems, setExpandedItems] = useState(['meetings', 'questions']);
        ...
        <div className="p-4 lg:p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            {sidebarOpen ? (
              <>
                <div>
                  <h2 className="text-gray-800 font-bold text-lg lg:text-xl">Admin Panel</h2>
                  <p className="text-gray-500 text-xs mt-1 hidden sm:block">Interview System</p>
                </div>
                <button 
                  onClick={() => setSidebarOpen(false)}
            ...
            if (item.type === 'parent') {
              return (
                <div key={item.id}>
                  ...
                  >
                    ...
                    {sidebarOpen && (
                      <>
                        <span className="flex-1 text-left text-sm lg:text-base font-medium">{item.label}</span>
                        {item.badge > 0 && (
                        ...
                        return (
                          <div key={child.id} className="relative">
                            ...
                            <div 
                              ...
                              style={{ left: '-12px', transform: 'translateY(-50%)' }}
                            ></div>
                            ...
                            >
                              ...
                              <ChildIcon className={`text-sm flex-shrink-0 ${isActive ? 'text-cyan-600' : ''}`} />
              ...
              return (
                ...
                >
                  ...
                  <Icon className={`text-lg flex-shrink-0 ${isActive ? 'text-cyan-600' : ''}`} />
                  {sidebarOpen && (
                    <>
