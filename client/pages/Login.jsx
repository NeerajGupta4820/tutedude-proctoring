...
const Login = () => {
  ...
  const [role, setRole] = useState('user'); // 'user' for interviewer, 'candidate' for candidate
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center bg-gray-100 overflow-hidden font-poppins">
      <img
        className="fixed left-0 bottom-0 h-full z-0 hidden md:block"
        src="../assets/wave.png"
        alt="wave"
      />
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-16 z-10">
        ...
        <div className="login-content flex items-center justify-center text-center">
          <form
            ...
            className="w-80 md:w-96 bg-white rounded-xl shadow-lg p-8"
          >
            <img
            ...
            />
            <h2 className="text-3xl font-bold text-cyan-700 uppercase mb-6">
              Welcome
            </h2>
            ...
            <div className="relative flex items-center border-b-2 border-gray-300 mb-6 focus-within:border-cyan-700">
              ...
              <input
                ...
                placeholder="Email"
                className="w-full py-2 px-2 outline-none text-lg bg-transparent"
              />
            </div>
            <div className="relative flex items-center border-b-2 border-gray-300 mb-6 focus-within:border-cyan-700">
              <span className="text-gray-400 mr-3 text-xl">
            ...
            <button
              type="submit"
              className="btn w-full h-12 rounded-full bg-cyan-700 text-white text-lg font-bold uppercase mt-4 hover:bg-cyan-800 transition"
            >
              Login
            </button>
