...
const Home = () => {
  ...
  // ✅ UPDATED: Use roomId instead of _id for consistency
  const handleNext = async (e) => {
    ...
    if (webcamOk && micOk) {
      // Use roomId if available, otherwise fallback to _id
      if (meeting) {
  ...
  return (
    <main className="bg-gray-200 min-h-screen font-sans">
      ...
      <section
        id="section-diferenciais"
        className="max-w-5xl mx-auto mt-14 px-4"
      >
        <h2 className="text-center text-cyan-700 font-bold text-4xl md:text-5xl py-8">
          Rules & Regulations
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
            <img
              ...
              src="../assets/101391-online-test_zu1cw4.gif"
              alt="image"
            />
            <p className="text-gray-700 text-center">
              Monitors your camera and microphone during the interview. When you
              load the interview, grant permissions for both to interview
              Proctor.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
            <img
              className="w-40 h-40 object-contain mb-4"
              src="../assets/Not-detect-face.png"
              alt="image"
            />
            <p className="text-gray-700 text-center">
              If the camera doesn't detect your face, System calls these events
              VIOLATIONS.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
          ...
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
            ...
            />
            <p className="text-gray-700 text-center">
              Once your face is detected, the first photo will be taken.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
            <img
              className="w-40 h-40 object-contain mb-4"
              src="../assets/Detect-two-persons.png"
              alt="image"
            />
            <p className="text-gray-700 text-center">
              Make sure that only you are in front of the interview. The
              background should be as clean as possible.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center hover:scale-105 transition-transform">
            <img
            ...
            />
            <p className="text-gray-700 text-center">
              You must take the interview in a quiet environment. If any sound
              is detected, it will be recorded.
            </p>
          </div>
        </div>
      </section>
      ...
      <h2
        id="section-header-prof"
        className="text-center text-cyan-700 font-bold text-4xl md:text-5xl py-8"
      >
      ...
      <section id="section-prof" className="max-w-3xl mx-auto mb-16 px-4">
        <div className="bg-cyan-700 text-white rounded-lg p-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-left">
            ...
            <li>
              You must take the interview in the same room that you scanned
              during the proctoring setup for the current interview.
            </li>
            <li>
              The room must be as quiet as possible. Sounds such as music or
              television are not permitted.
            </li>
            <li>
              No other person is allowed to enter the room while you are taking
              the proctored interview.
            </li>
            <li>
              The following items must not be on your desk or used during your
              proctored interview, unless posted rules for the interview
              specifically permit these materials: Books, Paper, Pens,
              Calculators, Textbooks, Notebooks, Phones.
            </li>
          </ul>
        </div>
      </section>
